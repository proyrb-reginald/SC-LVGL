...
#ifndef __sc32r803_DMA_H
#define __sc32r803_DMA_H
...
typedef enum
{
    ...
    DMA_DataSize_Word			= ( ( uint32_t ) 0x03U << DMA_CFG_TXWIDTH_Pos ),		 /*!< Peripheral data alignment: Word     */
...
typedef enum
{
    ...
    DMA_Request_TWI_QSPI0_TX		= ( ( uint32_t ) 0x000CU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI0 TX    */
    DMA_Request_TWI_QSPI0_RX		= ( ( uint32_t ) 0x000DU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI0 RX    */
    DMA_Request_TWI_QSPI1_TX		= ( ( uint32_t ) 0x000EU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI1 TX    */
    DMA_Request_TWI_QSPI1_RX		= ( ( uint32_t ) 0x000FU << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: SPI1 RX    */
    DMA_Request_TWI_SPI2_TX		= ( ( uint32_t ) 0x0014U << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: TWI0 TX    */
    DMA_Request_TWI_SPI2_RX		= ( ( uint32_t ) 0x0015U << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: TWI0 RX    */
    ...
    DMA_Request_TIM6_CAPF	= ( ( uint32_t ) 0x0031U << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: TIM6 Falling edge capture */
    DMA_Request_TIM6_CAPR	= ( ( uint32_t ) 0x0032U << DMA_CFG_REQSRC_Pos ),			/*!< DMA Requtest: TIM6 Rising edge capture  */
...
typedef enum
{
    DMA_DMAReq_CHRQ = ( uint32_t ) DMA_CFG_CHRQ, /*!<  DMA:  overflow */
} DMA_DMAReq_TypeDef;
